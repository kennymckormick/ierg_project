...
from .network import MTMLPActorCritic
...
class BaseTrainerMT:
    def __init__(self, enva, envb, config, myconfig={}):
        ...
        self.obs_dim = enva.observation_space.shape[0]
        self.act_dim = enva.action_space.shape[0]
        self.act_high = enva.action_space.high
        self.act_low = enva.action_space.low
        # should be in config
